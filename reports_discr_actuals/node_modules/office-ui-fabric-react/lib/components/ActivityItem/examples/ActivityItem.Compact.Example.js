...
export var ActivityItemCompactExample = function () {
    ...
    return (React.createElement("div", null, activityItemExamples.map(function (item) { return (React.createElement(ActivityItem, tslib_1.__assign({}, item, { key: item.key, className: classNames.exampleRoot }))); })));
};
