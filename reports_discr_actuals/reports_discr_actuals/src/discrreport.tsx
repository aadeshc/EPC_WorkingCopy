          ...
          for (let i in response.d.results) {
            ...
            if (
              ...
              var val =
                ...
                (parseInt(response.d.results[i].ETC) +
                  parseInt(response.d.results[i].Actuals));
              if (val > response.d.results[i].BudgetDeviation)
                isdiscrepancy = true;
            }
            ...
            if (isdiscrepancy == true) {
              ...
              example = (
                <div className="row text-center" style={{ marginTop: '100px' }}>
                  <Workbook filename="Discrepancy In Progress And Actuals Report.xlsx" element={<button className="btn btn-success">Export To Excel</button>}>
          ...
          {(state, makeTable, instance) => {
            ...
            return (
              <div className="main-grid">
                <div >
                  <div  >
                    <span className="ReportHeader"> <b>Report Name :</b>  </span> <b className="subsection">Projects with discrepancy in Budget, ETC and actuals </b>  &nbsp; &nbsp; &nbsp; <span className="ReportHeader"> <b> Total Count</b> </span> <b className="subsection">{recordsInfoText}</b> <span> {example}</span>
