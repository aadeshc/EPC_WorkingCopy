          ...
          {(state, makeTable, instance) => {
            ...
            return (
              <div className="main-grid">
                <div >
                  <div  >
                    <span className="ReportHeader"> <b>Report Name :</b>  </span> <b>Projects not updated in given number of days </b>  &nbsp; &nbsp; &nbsp; <span className="ReportHeader"> <b> Total Count</b> </span> <b>{recordsInfoText}</b> <span> {example}</span>
