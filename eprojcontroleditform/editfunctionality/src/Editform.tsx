...
import "./"
import {
  Label, Checkbox, PrimaryButton, Selection, SelectionMode, TextField, IPersonaProps,IPersona, DatePicker, DayOfWeek, Dropdown, values, DefaultButton, inputProperties, themeRulesStandardCreator 
      ...
      <br></br>
              ...
              <td> EditHardwareLE</td>
                <td> <SPPeoplePicker multi={false}  pickerEnabled={true} onChange={this.handleEEECLEChange(this)}  /> </td>
                            ...
                            <td>
                             ...
                             <td style={{paddingLeft: "20px"}}>
                              ...
                              <td colSpan={1}>
                                        ...
                                        <input type="text"    name="ProjectStartPeriod" id="addProjectStartPeriod" ref= {this.ProjectPeriod} value = {this.state.FinPeriod} onChange={this.handleTextChange} required disabled/>
                    ...
                    <tr>
                    <td style={{ paddingBottom: "10px" }}> Agreed Budget <b><span style={{color:"red"}}>*</span></b> </td>
                                    <td >  
        ...
        {/* <tr >
                    ...
                    <tr>
                             ...
                             <td>
                              ...
                              <td>
                                        ...
                                        <input type="text"   name="ILD" id="addILD"  required ref={this.ILD} onChange={this.handleTextChange} value={this.state.EditILD}/>
                    ...
                    <tr>
                            ...
                            <td>
                                        ...
                                        <input type="text"    name="ComplexLoops" id="addComplexLoops" ref={this.ComplexLoops} onChange={this.handleTextChange} value={this.state.EditComplexLoops} required/>
      ...
      <table className="addClosureEntry" id="addClosureEntry">
                    <tbody>
                            ...
                            <td style={{ width: '20%', paddingLeft: '16px' }}> Close out Notes </td>
                                    ...
                                    <textarea className="Remark" id="CloseOutNotes" value={this.state.EditCloseOut} ref={this.closeOut} onChange={this.handleTextChange} cols={116} rows={5}/>      
                                     </td>
                            </tr>
                            </tbody>
                            </table>
